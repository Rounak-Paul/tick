...
void filter(std::shared_ptr<Channel> in, std::shared_ptr<Channel> out) {
  println(100);
}
...
int main() {
  ...
  for (int tick = 0; tick < numTicks; tick++) {
    ...
    filter(gChannels["in"], gChannels["out"]);
